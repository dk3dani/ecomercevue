            ...
            <div class="shop">
              ...
              <div class="shop-body">
                ...
                <a href="#" class="cta-btn">
                 <router-link to="/produto" class="cta-btn">Compre Agora </router-link>
            ...
            <div class="section-title">
              ...
              <div class="section-nav">
                <ul class="section-tab-nav tab-nav">
                  ...
                  <li>
                    <a data-toggle="tab" href="#tab1">Accessorios</a>
                  </li>
                </ul>
              </div>
            </div>
                  ...
                  <div class="products-slick" data-nav="#slick-nav-1">
                    ...
                    <div class="product">
                      ...
                      <div class="product-body">
                        ...
                        <div class="product-btns">
                          <button class="add-to-wishlist">
                            ...
                            <span class="tooltipp">adcto wishlist</span>
                          </button>
                      ...
                      <div class="add-to-cart">
                        <button class="add-to-cart-btn" v-on:click="adicionarCarrinho">
 ...
 export default {
    name: "produto",
             ...
             data(){
                 return{
                     produto: "Notebook ",
                    descricao: "Notebook DELL Memória: 8GB HD: 2TB SSD: 480GB - LT-P10880G-13M",                
                    qtde: 15,
					favoritos:0,
                    emEstoque: false,
                    carrinho: 0}} 
